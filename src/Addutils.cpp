...
constexpr std::array OP{"com.miHoYo.GenshinImpact", "com.miHoYo.Yuanshen", "com.miHoYo.ys.mi",
						"com.miHoYo.ys.bilibili"};
constexpr std::array NP{"com.tencent.tmgp.sgamece", "com.tencent.tmgp.sgame"};
constexpr std::array BP{"com.miHoYo.bh3.mi", "com.tencent.tmgp.bh3", "com.miHoYo.enterprise.NGHSoDBeta",
...
static void qcom(const std::string &Frontpkgname) {
	/* Genshin */
...
static void mtk(const std::string &Frontpkgname) {
	/* Genshin */
	if (std::any_of(OP.cbegin(), OP.cend(), [&](const auto &it) { return Frontpkgname == it; })) {
...
static void old(const std::string &Frontpkgname) {
